...
int main(int argc, char **argv) {
    ...
    while (!WindowShouldClose()) {
        ...
        Rectangle side_panel_frame{
            padding, padding, (padding + 3 * (90 + padding)),
        ...
        side_panel.push_button(file); {
            Rectangle panel{
                side_panel_frame.width + side_panel_frame.x + padding, padding,
            ...
            Rectangle cmd_panel_frame{
                panel.x + padding, panel.y + panel.height - 100 - padding,
                panel.width - 2 * padding - padding - 2 * run_button_radius, 100
            };

            DrawRectangleRounded(cmd_panel_frame, 0.15f, 20, Colors::BG3);

            Vector2 run_button_center{
                panel.x + panel.width - padding - run_button_radius, cmd_panel_frame.y + run_button_radius + 10
            };
